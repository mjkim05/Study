...
--○ JDBC05 실습을 위한 쿼리문 작성

-- 직원테이블 INSERT
INSERT INTO TBL_EMP (EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) VALUES (EMPSEQ.NEXTVAL, '김신애', '810809-2111111', '2001-10-10', 6, '011-4151-4444', 1, 9, 900000 , 102000)
;

-- 직원 테이블 UPDATE (이름)
UPDATE TBL_EMP SET EMP_NAME = '청명', SSN = '80-55', IBSADATE = SYSDATE , CITY_ID = 5 , TEL = '010-7159-4231', BUSEO_ID = 5, JIKWI_ID = 5, BASICPAY = 1000000, SUDANG =15215 WHERE EMP_ID = '1060'
;

SELECT MIN_BASICPAY, JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '사장'
;
to_date('2024-12-45','yyyy-mm-dd')


-- 직원 테이블 DELETE
DELETE FROM TBL_EMP WHERE EMP_ID = '1060'
;

SELECT CITY_NAME , CITY_ID FROM TBL_CITY
;

SELECT BUSEO_ID , BUSEO_NAME FROM TBL_BUSEO
;

SELECT JIKWI_ID, JIKWI_NAME, MIN_BASICPAY FROM TBL_JIKWI
;
...
AS
SELECT E.EMP_ID , E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME ,E.BASICPAY ,E.SUDANG, C.CITY_ID, J.JIKWI_ID, B.BUSEO_ID
FROM TBL_EMP E JOIN TBL_CITY C 
     ON E.CITY_ID = C.CITY_ID
     JOIN TBL_BUSEO B 
     ON B.BUSEO_ID = E.BUSEO_ID
     JOIN TBL_JIKWI J
...
-- 1064	박문대	971215-1234567	16/06/18	서울	010-5959-7979	기획부	사장 5000000
2000000
...
INSERT INTO TBL_EMP (EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) 
VALUES (EMPSEQ.NEXTVAL, '채다선', '961023-2234567', TO_DATE('2019-06-08','YYYY-MM-DD')
        ,(SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '서울')
        ,'011-2356-4528'
        ,(SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '개발부')
        ,(SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '대리')
        ...
        , 200000);
--> 한줄 구성
INSERT INTO TBL_EMP (EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) VALUES (EMPSEQ.NEXTVAL, '채다선', '961023-2234567', TO_DATE('2019-06-08','YYYY-MM-DD'),(SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '서울'),'011-2356-4528',(SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '개발부'),(SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '대리'), 1650000, 200000)
;
--==>> 1 행 이(가) 삽입되었습니다.
COMMIT;
...
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE,CITY_NAME, BUSEO_NAME, JIKWI_NAME, BASICPAY, SUDANG, PAY
FROM EMPVIEW;
--> 한줄 구성
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE,CITY_NAME, BUSEO_NAME, JIKWI_NAME, BASICPAY, SUDANG, PAY FROM EMPVIEW
;
...
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE,CITY_NAME, NVL(TEL,'번호없음') AS TEL
