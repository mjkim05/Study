...
8	H001	2023-11-06	10	 500
9	H002	2023-11-06	20	 500
10	H003	2023-11-06	25	 500      ◀--------- 출고수량 변경 확인!
*/
...
H001	바밤바	 600	30
H002	죠스바	 500	30
H003	보석바	 500	10      ◀---------- 보석바 재고수량 변경 확인!
H004	누가바	 600	70
H005	쌍쌍바	 700	 0
H006	수박바	 500	 0
H007	알껌바	 500	 0
...
--==>>
/*
INSERT 쿼리가 실행되었습니다.	2023-11-07 16:14:48
INSERT 쿼리가 실행되었습니다.	2023-11-07 16:15:24
INSERT 쿼리가 실행되었습니다.	2023-11-07 16:17:21
UPDATE 쿼리가 실행되었습니다.	2023-11-07 16:18:52
DELETE 쿼리가 실행되었습니다.	2023-11-07 16:19:33
...
--==>> 에러발생 
--     (ORA-20003: 작업시간은 09:00 ~ 18:00 까지만 가능합니다.)
...
--○ 실습 환경 구성을 위한 데이터 생성 → TBL_TEST2
CREATE TABLE TBL_TEST2
( CODE  NUMBER
, NAME  VARCHAR2(40)
, CONSTRAINT TEST2_CODE_PK PRIMARY KEY(CODE)
);
--==>> Table TBL_TEAT2이(가) 생성되었습니다.

--○ 실습 환경 구성을 위한 데이터 생성 → TBL_TEST3
...
, CONSTRAINT TEST_CODE_FK FOREIGN KEY(CODE)
             REFERENCES TBL_TEAT2(CODE)
);


INSERT INTO TBL_TEAT2(CODE, NAME) VALUES (1,'텔레비전');
INSERT INTO TBL_TEAT2(CODE, NAME) VALUES (2,'냉장고');
INSERT INTO TBL_TEAT2(CODE, NAME) VALUES (3,'세탁기');
INSERT INTO TBL_TEAT2(CODE, NAME) VALUES (4,'건조기');
--==>> 1 행 이(가) 삽입되었습니다.
...
ALTER TABLE TBL_TEAT2 RENAME TO TBL_TEST2;
...
TRUNCATE TABLE TBL_입고;                      -- TRUNCATE 쓰면 자동 커밋!! 조심!!
...
INSERT INTO TBL_입고(입고번호, 상품코드, 입고일자, 입고수량, 입고단가)
VALUES(3,'H001',SYSDATE,100,1000);
