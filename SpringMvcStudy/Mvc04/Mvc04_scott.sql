...
VALUES (POSITIONSEQ.NEXTVAL, '»ç¿ø', 1000000);
--> ÇÑÁÙ±¸¼º
...
, LUNAR         NUMBER(1) DEFAULT 0     -- ¾ç·Â À½·Â     -- CK(¾ç·Â 0 À½·Â 1)
...
SELECT E.EMPLOYEEID
     ...
     , E.LUNAR
     , DECODE (E.LUNAR, 0, '¾ç·Â', 1, 'À½·Â') AS LUNARANAME
     , E.TELEPHONE
     , E.DEPARTMENTID
...
FROM EMPLOYEE E;
--==>> 1	°­Çý¼º	?o??^????	1997-10-17	0	¾ç·Â	1	°³¹ßºÎ	2	´ë¸®	1	¼­¿ï	2500000	1500000	4000000      


--¡Û ºä »ý¼º (EMPLOYEEVIEW) Æó±â
...
---------- ------------------------------ ----------- ----------
         1 »ç¿ø                               1000000          0   ¡æ »èÁ¦ °¡´É
         2 ´ë¸®                               2000000          1   ¡æ »èÁ¦ ºÒ°¡
         3 °úÀå                               3000000          0   ¡æ »èÁ¦ °¡´É
         4 ºÎÀå                               4000000          0   ¡æ »èÁ¦ °¡´É
*/
...
--¡Û ·Î±×ÀÎ, ·Î±×¾Æ¿ô °úÁ¤ Ãß°¡
-- ID¿Í PW Ä®·³ µ¥ÀÌÅÍ¸¦ ´ã°í ÀÖ´Â Å×ÀÌºíÀÌ º°µµ·Î Á¸ÀçÇÏÁö ¾Ê´Â »óÈ²ÀÌ´Ù.
-- ÀÌ¿Í °ü·ÃÇÏ¿© EMPLOYEEID(»ç¿ø ¾ÆÀÌµð¿Í) SSN(ÁÖ¹Î¹øÈ£) µÚ 7ÀÚ¸® ¼ýÀÚ¸¦
...
-- SSN1 ¡æ SUBSTR(º¹È£È­(´ë»ó µ¥ÀÌÅÍ,'9710171234567'),1,6) ¡æ '971017'
-- SSN2 ¡æ ¾ÏÈ£È­(SUBSTR(º¹È£È­(´ë»ó µ¥ÀÌÅÍ,'9710171234567'),7,7)
--               ,SUBSTR(º¹È£È­(´ë»ó µ¥ÀÌÅÍ,'9710171234567'),7,7)) ¡æ ¾ÏÈ£È­µÈ '1234567'
...
-- ÄÃ·³ Ãß°¡ ¡æ GRADE ¡æ ±âº» °ª 1À» ÀÏ¹Ý»ç¿øÀ¸·Î ±¸¼º
--                               0À» °ü¸®ÀÚ·Î ±¸¼º                        
ALTER TABLE EMPLOYEE
...
--   ÀÌ¸¦ ±â¹ÝÀ¸·Î »ý¼ºÇ× ºä(VIEW)³»¿ë ¶ÇÇÑ »õ·Î ÀÛ¼º(¼öÁ¤)
