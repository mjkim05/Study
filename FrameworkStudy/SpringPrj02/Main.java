...
public class Main
{
	public static void main(String[] args)
	{
		...
		Record rec1 = new RecordImpl1(); 				// RecordView 입장에서 dependency(의존 객체)
		
		// ② RecordImpl2(Record) 객체 생성 과정
		//RecordImpl2 rec2 = new RecordImpl2();
		Record rec2 = new RecordImpl2(); 				// RecordView 입장에서 dependency(의존 객체)
		...
		//   느슨한 결합을 구성할 수 있게 되고
		//   한 쪽의 변동상황이 다른쪽에 영향을 덜 줄 수 있게 된다.
		...
		*/
		...
		// 생성 및 관리할 객체에 대한 정보를 얻을 수 있도록 해야한다.
