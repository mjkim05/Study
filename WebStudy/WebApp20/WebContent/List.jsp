...
<%
	...
	//이전 페이지(?)로부터 넘어온 검색키와 검색 값 수신
	String searchKey = request.getParameter("searchKey");
	String searchValue = request.getParameter("searchValue");
	
	if (searchKey != null) 	// -- 검색 기능을 통해 이 페이지가 요청 되었을 경우
	{
		//테스트
		//System.out.println("searchKey : " + searchKey + ", searchValue : " +searchValue);	
		
		// 넘어온 요청이 GET 방식이라면... 디코딩 처리 할 수 있도록 코드 구성
	...
	// 전체 데이터 개수 구하기	→ 검색 데이터 개수 구하기로 변경 예정~~!!
	...
	// 실제 리스트 가져오기 → 검색 데이터 개수 구하기로 변경 예정~~!!
      ...
      <div id="leftHeader">
         ...
         <form action="" name="searchForm" method="post">
            <select name="searchKey" class="selectFiled">
               ...
               else									// 수신한 searchKey 가 없거나 subject 라면...
               {	   	
			   %>
			      <option value="subject">제목</option>
	              <option value="name" >작성자</option>
