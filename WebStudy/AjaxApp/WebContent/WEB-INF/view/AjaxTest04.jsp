...
<script type="text/javascript">
	...
	{
		//alert("확인~");
		var temp = document.getElementById("addrResult").value;
		var arr = temp.split("/");
		...
		// 포커스 맨날 까먹는 김민지;;;;;;;;;;;;;;;; 포커스 : 서운...ㅠ, 이용자 : 개불편; 클릭 한 번 더 해야됨;;;;
	}
	*/
	
	function selectZip(sel)
	{
		// 확인
		//alert(sel.value);
		/*
...
<table class="table">
	...
	<tr>
		...
		<td>
			...
			<br>
			<!-- <select id="addrResult" class="control" onchange="selectZip()"> -->
			<select id="addrResult" class="control" onchange="selectZip(this)">
				<option>주소를 입력하세요.</option>
			</select>
		</td>
	</tr>
