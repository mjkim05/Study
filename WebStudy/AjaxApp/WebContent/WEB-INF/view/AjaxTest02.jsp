...
<script type="text/javascript">
	...
	function sum()
	{
		...
		// 『true』: boolean → true 비동기 false 동기 , AJAX 처리 과정에서 동기는 안함.
		ajax.open("GET",url,true);
		// -- 실제 서버와의 연결이 아니고, 일종의 큰 의미에서 환경 설정 부분으로 이해하는 것
		//    (실제 서버 연결은 나중에...)
		
		// ajax 객체(→ XMLHttpRequest 객체)의 readyState 속성은
		// 각 단계별로 변화되며, 0부터 4까지 순차적으로 증가하는 형태로 변화한다.
		// 그 때 마다... 『readystatechange』 이벤트가 발생하게 된다.
		ajax.onreadystatechange = function ()
		{
			// 그 중에서... (0부터 4까지의 상태중에서..)
			// 4가 되는 순간이 요청했던 서버로부터 응답 준비가 완료된 시점이기 떄문에
