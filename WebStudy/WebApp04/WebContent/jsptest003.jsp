...
<!--
 	※ 요청한 페이지(jsptest003.jsp)의 결과를 확인한 후 새로고침을 반복해보면...
 	   a 변수(선언부에 선언한 변수) 값만 계속 증가하는 것을 확인 할 수 있
       a 변수 값만 계속 증가하는 이유를 확인해보기 위해서는 
       서블릿 코드를 분석해봐야 한다.
       
       즉, jsptest003.jsp의 서블릿 코드를 분석해야한다.
       ...
       -------------							-----------
        ...
        --==>> 변수 a는 클래스(jsptest003_jsp)의 전역 변수로 선언된 것을 확인할 수 있다.
               ...
               서비스가 시작될 때와 끝날 때 한번씩 실행되는 메소드이다.
               ...
               또한, JSP 페이지의 선언부 영역에서는 선언된 모든 변수는 
               ...
               ==>> 선언부는 클래스 영역안에 사용되는 것! 
                    스크립 릿은  _jspService() 메소드 안에서 사용되는 것! 
         -->
